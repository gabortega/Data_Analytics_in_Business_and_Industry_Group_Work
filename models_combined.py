...
####################### check notebook models_combined.ipynb ######################################
...
class DataMergeProcessor:
    ...
    def run(self) -> None:
        ...
        processed_transaction_data = pd.merge(processed_transaction_data, processed_transaction_data_count, left_index=True, right_index=True)
...
data_processed = pd.read_csv("processed_data_combined.csv")
